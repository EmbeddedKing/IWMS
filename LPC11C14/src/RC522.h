...
#define  RC522_RESET 3	 //port0
#define  RC522_NSS	 11	 //port0 
#define  RC522_SI	 1	 //port1
#define  RC522_SO	 2	 //port1
#define  RC522_SCK	 0	 //port1

#define  RCR22_SObit  ((LPC_GPIO1->DATA >> 2) & 0x001);
