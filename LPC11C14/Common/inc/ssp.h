...
#define SSP_SLAVE		1		/* 1 is SLAVE mode, 0 is master mode */
...
//#define USE_CS			0
#define SSP_DEBUG		1//0

/* SPI read and write buffer size */
//#define SSP_BUFSIZE		11
#define FIFOSIZE		8
...
unsigned short SPI0_slaveRS( unsigned char  portNum, unsigned char  buf );
